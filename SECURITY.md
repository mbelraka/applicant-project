...
| **A06 Vulnerable components** | Keep `npm` and Maven dependencies updated; CI runs OWASP Dependency-Check (CVSS ≥ 8 fails) on every backend push/PR; SpotBugs + FindSecBugs on `verify`. |
